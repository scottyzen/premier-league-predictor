<template>
  <div class="wrapper px-4 pt-4 md:pt-16 h-screen shadow-lg" :class="{'move-right': menuIsOpen}">
    ...
    <transition name="slide">
      <div
        class="alert fade absolute pin-t bg-purple-lightest border-l-4 border-purple rounded-b text-left text-purple-darkest px-6 pt-5 pb-3 my-4 shadow-md"
    ...
    <div class="max-w-lg m-auto mt-20">
      ...
      <h1
        class="mb-6 md:px-6 text-3xl sm:text-4xl fat-frank uppercase"
